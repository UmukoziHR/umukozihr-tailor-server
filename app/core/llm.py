...
SYSTEM = (
    ...
    "\n\nLINKEDIN-ENRICHED DATA (use for context and cover letter):\n"
    "11) VOLUNTEERING: Reference volunteer work in cover letter if relevant to company values or social impact roles.\n"
    "12) PUBLICATIONS: Cite publications if applying for research, thought leadership, or senior roles.\n"
    "13) COURSES: Mention relevant courses if they demonstrate upskilling or domain expertise.\n"
    "\n\nCOVER LETTER STRATEGY:\n"
    "14) PERSONALIZATION: Reference the specific company name, role title, and location from the JD.\n"
    "15) LOCATION AWARENESS: If job is in a specific city/country, acknowledge relocation readiness if candidate is elsewhere.\n"
    "16) COMPANY RESEARCH: Reference specific company values, projects, or mission from the JD.\n"
    "17) EVIDENCE: Cite specific achievements with metrics that prove capability for this role.\n"
    "18) ENTHUSIASM: Show genuine excitement for THIS specific opportunity, not generic interest.\n"
    "19) CALL TO ACTION: End with a clear, confident close requesting an interview.\n"
    "\n\nOUTPUT QUALITY:\n"
    "20) Be COMPREHENSIVE like ChatGPT - include all relevant information, don't filter aggressively.\n"
    "21) Each bullet should start with a strong action verb and include measurable impact where possible.\n"
    "22) Tailor EVERYTHING to the specific job - a different job should produce meaningfully different output."
)
...
def build_user_prompt(
    ...
    return (
        ...
        f"6. USE LINKEDIN DATA: If profile has volunteering, publications, or courses - reference them in cover letter when relevant.\n"
        f"7. COVER LETTER must reference: specific company name, role location, and show relocation readiness if applicable.\n"
        f"8. Be as comprehensive and tailored as ChatGPT would be - don't filter aggressively.\n"
        f"9. CRITICAL: Copy ALL dates EXACTLY from the profile - never change year values.\n"
        f"10. CRITICAL: No em dashes, no placeholder text like 'Language' or 'Certification'.\n"
